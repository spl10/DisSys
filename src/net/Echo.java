...
public class Echo implements ActionListener, Runnable {
	...
	private static final String HOST = "131.159.52.1";
	private static final int PORT = 50000;
	private final JFrame f = new JFrame();
	private final JTextField tf = new JTextField(50);
	private final JTextArea ta = new JTextArea(20, 30);
	...
	public static enum Kind {
		...
		Client(100, "Connecting"), Server(500, "Awaiting");
		private int offset;
	...
	public void run() {
		try {
			...
			while (true) {
				...
				display("EchoClient> " + in.nextLine());
			}
		} catch (Exception e) {
